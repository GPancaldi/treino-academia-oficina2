...
@Component({
  selector: 'app-workouts-customers-list',
  templateUrl: './workouts-customers-list.component.html',
  styleUrls: ['./workouts-customers-list.component.scss']
})
export class WorkoutsCutomersListComponent implements OnInit {
